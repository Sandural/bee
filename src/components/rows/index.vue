...
let myArray = [
  {
    svgDOM: `<svg
          ...
          height="55px"
        >
          <g id="one-column-text">
            <g id="Page-1">
              <g id="one-column-text-2" data-name="one-column-text">
                <g id="Rows">
                  <g id="Group">
                    <g id="Rectangle-61">
                      <rect
  ...
  {
    svgDOM: `<svg width="320px" height="55px" viewBox="0 0 321 55" fill="none">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M82.5 0H207.5H214.5H320.5V55H214.5H207.5H82.5V0Z"
            fill="#E0E0E0"
            class="icon--color-light"
          ></path>
          <path
            d="M74.3602 0H0V55H74.3602V0Z"
            fill="#E0E0E0"
            class="icon--color-light"
          ></path>
          <rect
...
<style>
.draggable-Sidebar__2qD4V_wrapper > :first-child {
  display: flex;
  flex-direction: column;
  row-gap: 18px;
}

.draggable-Sidebar__2qD4V {
  min-height: 0;
  padding: 15px;
...
.draggable-Sidebar__2qD4V svg {
  display: block;
  margin: auto;
}

.draggable-Sidebar__2qD4V:hover {
  cursor: grab;
  -webkit-box-shadow: 0 4px 8px rgb(0 0 0 / 32%);
  box-shadow: 0 4px 8px rgb(0 0 0 / 32%);
  border: 1px solid rgb(255 255 255);
  -webkit-box-shadow: 0 6px 10px rgb(0 0 0 / 35%);
